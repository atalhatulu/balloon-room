...
var base_rate_table: Array = [0.85, 1.5, 2.5, 4.0, 6.5, 10.0, 15.0, 22.0, 32.0, 48.0, 70.0, 105.0, 150.0]
...
var balloons_per_second: float = 0.85
var max_room_balloons: int = 500
