...
var cooldown_intervals: Array[float] = [1.2, 0.80, 0.50, 0.30, 0.18]
var laser_ranges: Array[float] = [8.0, 12.0, 18.0, 26.0, 36.0]
var max_targets_per_burst: Array[int] = [2, 4, 6, 9, 14]
